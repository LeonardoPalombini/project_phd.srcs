...
## Buttons
set_property -dict { PACKAGE_PIN D9    IOSTANDARD LVCMOS33 } [get_ports { sysRst }]; #IO_L6N_T0_VREF_16 Sch=btn[0]
...
## USB-UART Interface
set_property -dict { PACKAGE_PIN D10   IOSTANDARD LVCMOS33 } [get_ports { sysOut }]; #IO_L19N_T3_VREF_16 Sch=uart_rxd_out
set_property -dict { PACKAGE_PIN A9    IOSTANDARD LVCMOS33 } [get_ports { sysIn }]; #IO_L14N_T2_SRCC_16 Sch=uart_txd_in
